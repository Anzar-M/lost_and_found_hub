    ...
    <nav class="bg-blue-600 p-4">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-white text-2xl font-bold">Lost and Found Hub - Admin</h1>
                <button><a href="report_item.php" class="text-white bg-green-500 hover:bg-green-800 rounded-lg px-5 py-1">Report lost item</a></button>
            <a href="admin_login.php" class="text-white bg-red-700 hover:bg-red-800 rounded-lg px-5 py-1">Sign Out</a>
        </div>
    </nav>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='border px-4 py-2'><a href='delete_item.php?id=" . $row['id'] . "' class='text-red-600'>Delete</a> 
                        <br>
                        <a href='update_item.php?id=" . $row['id'] . "' class='text-blue-600'>Edit</a> 
                        </td>";
                        echo "</tr>";
                    }
                } else {
